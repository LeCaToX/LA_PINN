...
exportgraphics(gcf,'cube_KAN_dissipation_views.pdf','ContentType','vector');
...
grid on;
box on;
exportgraphics(gcf,'cube_KAN_history.pdf','ContentType','vector');
